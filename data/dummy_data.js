...
export const MEALS = [
  ...
  new Meal(
    ...
    'Elden Ring es un videojuego de rol de fantasía oscura.Los guerreros de Lord Godfrey fueron despojados de su Gracia y desterrados de las tierras, pero con la promesa de que, algún día, la Gracia les sería devuelta después de su muerte y los guiaría a su hogar a través de la niebla: Las Tierras Intermedias. Se profetiza que uno de ellos, o un descendiente, se parará ante Elden Ring y se convertirá en Señor. Con una amplia variedad de armas, hechizos, armaduras y objetos, tú decides cómo subir de nivel una pelea, y ajustando tus estadísticas y atributos decidirás tu competencia y medios de supervivencia.',
    '',
    [
  ...
  new Meal(
    ...
    'League of Legends (de siglas LoL) es un juego gratuito del género videojuego multijugador de arena de batalla en línea (Multiplayer Online Battle Arena, MOBA en inglés) creado por la compañía Riot Games.',
    '',
    [
      '4 Chicken Breasts',
      '1 Onion',
  ...
  new Meal(
    ...
    'Outlast es un juego de terror de supervivencia en primera persona desarrollado por Red Barrels. En el juego, juegas como el periodista de investigación Miles Upshur, que explora el espeluznante Mount Massive Asylum. Tu objetivo es sobrevivir el tiempo suficiente para descubrir el terrible secreto del manicomio. El juego enfatiza el juego basado en el sigilo, donde correr o esconderse es tu mejor oportunidad contra los aterradores habitantes.',
    '',
    [
  ...
  new Meal(
    ...
    'Candy Crush Saga es un juego de rompecabezas británico-sueco, muy parecido a Bejeweled, creado por el equipo británico de desarrollo de juegos de Facebook, King.com. La diferencia entre él y Bejeweled es que el juego tiene un modo historia; Los niveles pueden tener múltiples objetivos requeridos, más entidades y elementos y, obviamente, tiene caramelos en lugar de joyas.',
    '',
    [
